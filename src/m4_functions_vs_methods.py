...
def try_methods():
    ...
    ####################################################################
    todo3 = rg.SimpleTurtle()
    todo3.pen = rg.Pen('brown',5)
...
def try_methods_and_functions():
    ...
    #
    ####################################################################
    GuGu = rg.SimpleTurtle('turtle')
    GuGu.pen = rg.Pen('blue',5)

    GuGu.backward(150)

    GuGu.speed=1
    draw_many_squares(GuGu, 2, 100, 30)

    GuGu.speed=5
    GuGu.pen = rg.Pen('red',5)
    draw_many_squares(GuGu, 10, 50, 15)

    GuGu.speed=100
    GuGu.pen = rg.Pen('red',35)
    draw_many_squares(GuGu, 8, 300, 60)

    GuGu.pen = rg.Pen('black',3)
