...
def turtle4():
    """
    turtle4 moves forward 250 unit
    and then draw an octagon with color cyan4
    """
    wada = rg.SimpleTurtle()
    wada.pen = rg.Pen('cyan4',66)

    wada.forward(250)

    wada.draw_regular_polygon(8,88)

def turtle5():
    """
    makes two new turtles move around a bit.
    """
    GG = rg.SimpleTurtle('circle')
    GG.pen = rg.Pen('Darkkhaki',6)

    JJ = rg.SimpleTurtle('square')
    JJ.pen = rg.Pen('DarkSalmon',6)
